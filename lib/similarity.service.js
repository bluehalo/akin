 ...
 *
 */
var getUserSimilarityNumber = function(userWeightRow1, user1Items, userWeightRow2, user2Items) {
    ...
    _.forEach(_.keys(user1Items), function(potentialItemIdMatch) {
 ...
 *
 */
var calculateUserSimilarity = function(allUserSimilarities, user1) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        ModelService.getItemWeightsForUser(user1)
            ...
            .then(function(otherUserItemWeightsCursor) {
                ...
                otherUserItemWeightsCursor.on('data', function(otherUserItemWeight) {
 ...
 *
 */
var calculateAndSaveUserSimilarity = function(allUserSimilarities, userId) {
    // log.info('Calculating similarity for %s', userId);

    return calculateUserSimilarity(allUserSimilarities, userId)
                .then(function(usersSimilarities) {
 ...
 *
 */
var calculateUserSimilarities = function(allUserIds) {
 ...
 *
 */
module.exports.recalculateUserSimilarities = function() {
