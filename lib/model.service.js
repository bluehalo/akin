...
const UserActivity = mongoose.model('UserActivity'),
    ...
    UserRecommendationWrite = mongoose.model('UserRecommendationWrite'),
...
const model = {
    ...
    UserRecommendationWrite: UserRecommendationWrite,
...
module.exports = {
    ...
    dropUserRecommendationsWrite: dropAllByModel.bind(null, UserRecommendationWrite),
    getActivityForUser,
